...
% get the best para: (theta_bst, M_bst)
dir_result = '../rslt.python/';
flnm_para_bst = [dir_result, 'para.bst/', ...
    num2str(wait_days_train), 'd/', data_name];
...
for ss = 1:length(seed_lst)
    ...
    dir_rslt_eval_wtt = [dir_result, 'rslt.save/', data_name, '/', ...
        num2str(wait_days_train), 'd/theta', num2str(theta_bst), ...
        '_M', num2str(M_bst), '/T',num2str(total_eval_steps), ...
